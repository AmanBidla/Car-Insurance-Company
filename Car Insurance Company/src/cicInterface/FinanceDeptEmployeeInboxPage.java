 ...
 * @author george
 */
public class FinanceDeptEmployeeInboxPage extends javax.swing.JFrame {

    /**
     * Creates new form FinanceDeptEmployeeInboxPage
     */
    public FinanceDeptEmployeeInboxPage() {
        initComponents();
        if (Application.MessageToFinanceDeptEmployee>0){
    ...
    private void ReadMessage_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReadMessage_ButtonActionPerformed
            ...
            EmployeeCDOutboxPage employeeCDOutbox=new EmployeeCDOutboxPage();
            this.SenderRole_TextField.setText("Employee Of CD");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinanceDeptEmployeeInboxPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinanceDeptEmployeeInboxPage().setVisible(true);
            }
        });
    }
