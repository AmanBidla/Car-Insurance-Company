 ...
 * @author george
 */
public class EmployeeCDOutboxPage extends javax.swing.JFrame {

    /**
     * Creates new form EmployeeCDOUtboxPage
     */
    public static String employeeCDName;
    public static String employeeCDMessage;
    
    public EmployeeCDOutboxPage() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmployeeCDOutboxPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmployeeCDOutboxPage().setVisible(true);
            }
        });
    }
