 ...
 * @author george
 */
public class ClaimHandlerAOutboxPage extends javax.swing.JFrame {

    /**
     * Creates new form ClaimHandlerAOutbox
     */
    public static String chAName;
    public static String chAMessage;
    
    public ClaimHandlerAOutboxPage() {
        initComponents();
    }
    ...
    private void SendMessage_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SendMessage_ButtonActionPerformed
        ...
        switch (recipientRole){
            ...
            Application.MessageFromClaimHandlerA++;
            break;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClaimHandlerAOutboxPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClaimHandlerAOutboxPage().setVisible(true);
            }
        });
    }
