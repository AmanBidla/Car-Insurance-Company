...
public class Application {
    ...
    public static int unclassifiedFirst=0;
    ...
    public static Claim[] classifiedClaims=new Claim[10];
    public static int classifiedIndex=0;
    public static int classifiedFirst=0;
